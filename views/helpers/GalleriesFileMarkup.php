...
class CuratescapeGalleries_View_Helper_GalleriesFileMarkup extends Zend_View_Helper_Abstract{
	public function GalleriesFileMarkup($html, $args){
		if(
			!str_starts_with(current_url(),'/files/show/') ||
			!option('curatescapegalleries_file_markup') ||
			!isset($args) ||
			is_admin_theme()
		) return $html;
		if(
